...
class AssistedFactoryTransformerTest : MetroCompilerTest() {
  ...
  fun `assisted parameter mismatch - different types`() {
    compile(
      ...
      assertDiagnostics(
        """
        e: ExampleClass.kt:11:9 Parameter mismatch. Assisted factory and assisted inject constructor parameters must match (name and type) but found differences:
  ...
  fun `assisted parameter mismatch - different identifiers`() {
    compile(
      ...
      assertDiagnostics(
        """
        e: ExampleClass.kt:12:9 Parameter mismatch. Assisted factory and assisted inject constructor parameters must match (name and type) but found differences:
          Missing from factory:
            - count: String
          Missing from constructor:
            - notcount: Int
  ...
  fun `assisted types cannot be depended on directly - class`() {
    compile(
      ...
      assertDiagnostics(
        """
        e: ExampleClass.kt:25:34 ExampleClass uses assisted injection and cannot be injected directly here
  ...
  fun `assisted types cannot be depended on directly - provider`() {
    compile(
      ...
      assertDiagnostics(
        """
        e: ExampleClass.kt:22:47 ExampleClass uses assisted injection and cannot be injected directly here
  ...
  fun `assisted types cannot be depended on directly - member`() {
    compile(
      ...
      assertDiagnostics(
        """
        e: ExampleClass.kt:25:24 ExampleClass uses assisted injection and cannot be injected directly into
  ...
  fun `assisted types cannot be depended on directly - accessor`() {
    compile(
      ...
      assertDiagnostics(
        """
        e: ExampleClass.kt:19:21 ExampleClass uses assisted injection and cannot be injected directly here
  ...
  fun `assisted types cannot be depended on directly - accessor with no other ref`() {
    compile(
      ...
      assertDiagnostics(
        """
        e: ExampleClass.kt:21:21 ExampleClass uses assisted injection and cannot be injected directly here
