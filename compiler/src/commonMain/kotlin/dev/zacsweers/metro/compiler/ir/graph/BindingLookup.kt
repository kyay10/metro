...
internal class BindingLookup(
  ...
  private data class MultibindsDeclaration(
    ...
    val annotation: MetroIrAnnotation,
  ...
  private fun computeMultibindingTypeKey(
    annotations: dev.zacsweers.metro.compiler.MetroAnnotations<MetroIrAnnotation>,
    valueType: IrType,
    qualifier: MetroIrAnnotation?,
  ): IrTypeKey {
    return when {
